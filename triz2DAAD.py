...
def imprimePRO0_DR():
        ...
        print('                XPICTURE @fPlayer        ; Si hay una imagen, cargarla', file = f)
        print('#endif', file = f)
        print('#ifdef "nativeraster"', file = f)
        print('                DISPLAY @fDarkF         ; Y mostrarla si no está oscuro, en caso contrario, borra la ventana', file = f)
        print('#endif', file = f)
        print('#ifdef "next"', file = f)
        print('                GT  20 127               ; Muestralo si no oscuro; si oscuro', file = f)
        print('                XNEXTCLS                 ; Deshabilita y borra Layer2', file = f)
        print('#endif', file = f)
        print('', file = f)
        ...
        print('                XPICTURE 255            ; Si XPICTURE falló, trata de poner el gráfico de relleno 255', file = f)
        print('                #ifdef "nativeraster"', file = f)
        print('                                DISPLAY @fDarkF         ; Y mostrarlo si no está oscuro, en caso contrario, borra la ventana', file = f)
        print('                #endif', file = f)
        print('#endif', file = f)
        print('', file = f)
        print('', file = f)
        print('#ifndef "hasSplitMode"', file = f)
        print('> _        _    GT 20 127                ; XPICTURE falló', file = f)
        print('                CLS', file = f)
        print('                WINDOW 1', file = f)
        print('                WINAT 0 0', file = f)
        print('                WINSIZE 25 127           ; Full screen', file = f)
        print('                CLS', file = f)
        print('                SKIP 1', file = f)
        print('#endif', file = f)
        print('', file = f)
...
def imprimePRO6_DR():
        ...
        print('', file=f)    
        print('#ifndef "zx128"', file=f)
        print('> _       _     WINDOW  1               ; Inicializamos las ventanas', file=f)
        print('                #ifdef "pc"', file=f)
        ...
        print('                    WINAT   0       0', file=f)
        print('                #endif', file=f)
        print('                WINSIZE 25      127     ; Tamaño máximo', file=f)
        print('                CLS', file=f)
        print('                DESC    0               ; Introducción', file=f)
        print('                #ifndef "tape"', file=f)
        print('                    #ifdef "nativeraster"', file=f)
