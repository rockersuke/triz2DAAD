...
def imprimeDEF():
        ...
        if daadReady:
                ...
                print('#endif', file = f)
                print('', file = f)
                print('#ifndef "msx"', file = f)
                print('#ifndef "tape48"', file = f)
                print('#ifndef "c64"', file = f)
                print('#ifndef "cpc"', file = f)
                print('#ifndef "cp4"', file = f)
...
def imprimePRO0_DR():
        ...
        print('', file = f)
        print('>', file = f)
        print('_       _     #ifdef "splitModeOn"', file = f)
        print('                  CLS', file = f)
        print('                  XSPLITSCR 0', file = f)
        print('              #endif', file = f)
        print('              WINDOW 1', file = f)
...
def imprimePRO6_DR():
        ...
        print('                SET fCPronounNoun', file=f)
        print('                SET fCPronounAdject', file=f)
        print('                LET fObjectsCarried NUM_CARRIED', file=f)
        print('                LET fObjFlags 64', file=f)
        if idloc:
            print('                GOTO '+listLocationIdentifiers[startRoom-1], file=f)
        else:
