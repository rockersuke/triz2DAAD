...
Triz2DAAD versión 1.0.4b9 230109 (c) 2019-23 Pedro Fernández
...
**NUEVO**: la opción -dr creará una plantilla compatible con DAAD Ready 0.7. En este modo la barra de estado y la opción -md quedan desactivadas.
...
Triz2DAAD version 1.0.4b9 230109 (c) 2019-23 Pedro Fernández
...
**NEW**: -dr option will create a DAAD Ready 0.7 compatible template. In this mode status line and -md options are disabled.
